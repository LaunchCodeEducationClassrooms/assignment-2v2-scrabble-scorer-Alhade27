...
if(scoreChoice===0){
  console.log(scoringAlgorithms[0]["scoringFunction"](word),"- points for",word);
}else if(scoreChoice===1){
  console.log(scoringAlgorithms[1]["scoringFunction"](word),"- points for",word);
}else if(scoreChoice===2){
  console.log(scoringAlgorithms[2]["scoringFunction"](word),"- points for",word);
}
}
